    ...
    <div className="p-4 md:p-6">
      ...
      <div className="overflow-x-auto bg-white rounded-xl shadow-lg border border-gray-200">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gradient-to-r from-blue-50 to-indigo-50">
            <tr>
              <th scope="col" className="px-4 py-4 md:px-6 md:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                Service
              </th>
              <th scope="col" className="px-4 py-4 md:px-6 md:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                Provider
      ...
      <div className="mt-6 md:hidden">
        <div className="space-y-4">
          {payments.map((payment) => (
            <div key={payment._id} className="bg-white rounded-xl shadow-md border border-gray-200 p-4">
